...
fn normalize_path_for_skill_id_repo_scoped_uses_relative_path() {
    ...
    let skill_path = PathBuf::from("/repo/root/.gienx/skills/doc/SKILL.md");
    ...
    assert_eq!(path, ".gienx/skills/doc/SKILL.md");
}

#[test]
fn normalize_path_for_skill_id_user_scoped_uses_absolute_path() {
    let skill_path = PathBuf::from("/Users/abc/.gienx/skills/doc/SKILL.md");
...
fn normalize_path_for_skill_id_repo_root_not_in_skill_path_uses_absolute_path() {
    let repo_root = PathBuf::from("/repo/root");
    let skill_path = PathBuf::from("/other/path/.gienx/skills/doc/SKILL.md");
...
async fn reducer_includes_plugin_id_for_plugin_skill_invocations() {
    ...
    let skill_path =
        PathBuf::from("/Users/abc/.gienx/plugins/cache/test/sample/skills/doc/SKILL.md");
